        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 mb-16 sm:mb-20">
          ...
          <div className="bg-white dark:bg-neutral-950 border border-neutral-200/90 dark:border-neutral-800 rounded-3xl p-8 sm:p-10 shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <div className="w-full overflow-hidden rounded-2xl bg-neutral-50 dark:bg-neutral-900 border border-neutral-200/80 dark:border-neutral-800 p-5 sm:p-6 flex items-center justify-center">
                <img
                  src="https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_360/v1785768020/2_mnahho.png"
                  srcSet="https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_320/v1785768020/2_mnahho.png 320w, https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_360/v1785768020/2_mnahho.png 360w, https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_480/v1785768020/2_mnahho.png 480w, https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_640/v1785768020/2_mnahho.png 640w"
          ...
          <div className="bg-white dark:bg-neutral-950 border border-neutral-200/90 dark:border-neutral-800 rounded-3xl p-8 sm:p-10 shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <div className="w-full overflow-hidden rounded-2xl bg-neutral-50 dark:bg-neutral-900 border border-neutral-200/80 dark:border-neutral-800 p-5 sm:p-6 flex items-center justify-center">
                <img
                  src="https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_360/v1785768021/3_usiozw.png"
                  srcSet="https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_320/v1785768021/3_usiozw.png 320w, https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_360/v1785768021/3_usiozw.png 360w, https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_480/v1785768021/3_usiozw.png 480w, https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_640/v1785768021/3_usiozw.png 640w"
                  sizes="(max-width: 480px) 300px, 360px"
          ...
          <div className="bg-white dark:bg-neutral-950 border border-neutral-200/90 dark:border-neutral-800 rounded-3xl p-8 sm:p-10 shadow-sm hover:shadow-md transition-all flex flex-col justify-between md:col-span-2 lg:col-span-1">
            <div className="space-y-6">
              ...
              <div className="w-full overflow-hidden rounded-2xl bg-neutral-50 dark:bg-neutral-900 border border-neutral-200/80 dark:border-neutral-800 p-5 sm:p-6 flex items-center justify-center">
                <img
                  src="https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_360/v1785768022/Sem_t%C3%ADtulo_crcwaj.png"
                  srcSet="https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_320/v1785768022/Sem_t%C3%ADtulo_crcwaj.png 320w, https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_360/v1785768022/Sem_t%C3%ADtulo_crcwaj.png 360w, https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_480/v1785768022/Sem_t%C3%ADtulo_crcwaj.png 480w, https://res.cloudinary.com/nds7zozp/image/upload/f_auto,q_auto,w_640/v1785768022/Sem_t%C3%ADtulo_crcwaj.png 640w"
                  sizes="(max-width: 480px) 300px, 360px"
